-- =====================================================
-- Migration: Ajout et correction des politiques RLS (VERSION CORRIGÉE)
...
BEGIN
  IF EXISTS (
    ...
    -- Supprimer TOUTES les anciennes politiques (y compris les doublons)
    ...
    RAISE NOTICE '✅ Anciennes politiques supprimées sur documents';
  END IF;
END $$;
...
BEGIN
  IF EXISTS (
    ...
    RAISE NOTICE '✅ Politiques de base créées sur documents';
  END IF;
END $$;
...
BEGIN
  IF EXISTS (
    ...
    RAISE NOTICE '✅ Politiques RLS complètes créées sur documents';
  ELSE
